                                        ...
                                        <a class="dropdown-item border-bottom" href="{{ url('chat') }}">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span
                                                        class="avatar avatar-md brround align-self-center cover-image"
                                                        data-image-src="{{ asset('assets/images/users/2.jpg') }}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom" href="{{ url('chat') }}">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span
                                                        class="avatar avatar-md brround align-self-center cover-image"
                                                        data-image-src="{{ asset('assets/images/users/3.jpg') }}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item" href="{{ url('chat') }}">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span
                                                        class="avatar avatar-md brround align-self-center cover-image"
                                                        data-image-src="{{ asset('assets/images/users/7.jpg') }}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                            ...
                            <div class="dropdown header-notify d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow  animated">
                                    ...
                                    <div class="notify-menu">
                                        ...
                                        <a href="{{ url('email-inbox') }}"
                                            class="dropdown-item border-bottom d-flex ps-4">
                                            <div class="notifyimg  text-danger bg-danger-transparent border-danger"> <i
