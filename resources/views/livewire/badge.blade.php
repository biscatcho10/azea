							...
							<div class="col-xl-12">
								<div class="card ">
									...
									<div class="card-body ">
										...
										<button type="button" class="btn btn-success position-relative me-5 mb-2">
											Inbox
											<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
											  99+
											  <span class="visually-hidden">unread messages</span>
										...
										<button type="button" class="btn btn-danger position-relative me-5 mb-2">
											Inbox
											<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
											  99+
											  <span class="visually-hidden">unread messages</span>
										...
										<button type="button" class="btn btn-warning position-relative me-5 mb-2">
											Inbox
											<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
											  99+
											  <span class="visually-hidden">unread messages</span>
