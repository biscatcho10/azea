						...
						<div class="row">
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										...
										<img src="{{asset('assets/images/photos/1.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
											<div class="ms-auto">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/2.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/3.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/4.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/5.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/6.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/7.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/8.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="javascript:void(0);"></a>
										<img src="{{asset('assets/images/photos/9.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="javascript:void(0);" class="d-flex"><i class="fe fe-calender fs-16 me-1 p-3 bg-secondary-transparent brround text-secondary font-weight-bold border-secondary"></i><span class="mt-3 ms-1 text-muted font-weight-semibold"> July-18-2021</span></a>
