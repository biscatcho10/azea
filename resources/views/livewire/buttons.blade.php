						...
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											...
											<a href="javascript:void(0);" class="btn bg-secondary-transparent">Secondary</a>
							...
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="javascript:void(0);" class="btn bg-primary-transparent disabled">Primary</a>
											<a href="javascript:void(0);" class="btn bg-secondary-transparent disabled">Secondary</a>
											<a href="javascript:void(0);" class="btn bg-success-transparent disabled">Success</a>
											<a href="javascript:void(0);" class="btn bg-info-transparent disabled">Info</a>
											<a href="javascript:void(0);" class="btn bg-teal-transparent disabled">Teal</a>
											<a href="javascript:void(0);" class="btn bg-warning-transparent disabled">Warning</a>
											<a href="javascript:void(0);" class="btn bg-danger-transparent disabled">Danger</a>
											<a href="javascript:void(0);" class="btn bg-dark-transparent disabled">Dark</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="javascript:void(0);" class="btn btn-pill bg-primary-transparent">Primary</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-secondary-transparent">Secondary</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-success-transparent">Success</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-info-transparent">Info</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-teal-transparent">Teal</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-warning-transparent">Warning</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-danger-transparent">Danger</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-dark-transparent">Dark</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="javascript:void(0);" class="btn btn-pill bg-primary-transparent disabled">Primary</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-secondary-transparent disabled">Secondary</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-success-transparent disabled">Success</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-info-transparent disabled">Info</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-teal-transparent disabled">Teal</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-warning-transparent disabled">Warning</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-danger-transparent disabled">Danger</a>
											<a href="javascript:void(0);" class="btn btn-pill bg-dark-transparent disabled">Dark</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button type="button" class="btn bg-primary-transparent"><i class="fe fe-plus"></i></button>
											<button type="button" class="btn bg-warning-transparent"><i class="fe fe-heart"></i></button>
											<button type="button" class="btn bg-success-transparent"><i class="fe fe-check"></i></button>
											<button type="button" class="btn bg-danger-transparent"><i class="fe fe-link"></i></button>
											<button type="button" class="btn bg-info-transparent"><i class="fe fe-message-circle"></i></button>
											<button type="button" class="btn bg-teal-transparent"><i class="fe fe-trash"></i></button>
											<button type="button" class="btn bg-dark-transparent"><i class="fe fe-upload"></i></button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="javascript:void(0);" class="btn btn-outline-light disabled">Light</a>
						...
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											...
											<button type="button" class="btn btn-teal"><i class="fe fe-upload me-2"></i>Upload</button>
							...
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button type="button" class="btn btn-primary btn-svgs btn-svg-white"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M16.5 5c-1.54 0-3.04.99-3.56 2.36h-1.87C10.54 5.99 9.04 5 7.5 5 5.5 5 4 6.5 4 8.5c0 2.89 3.14 5.74 7.9 10.05l.1.1.1-.1C16.86 14.24 20 11.39 20 8.5c0-2-1.5-3.5-3.5-3.5z" opacity=".3"></path><path d="M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z"></path></svg> <span class="btn-svg-text">Like</span></button>
											<button type="button" class="btn btn-dark btn-svgs btn-svg-white"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3"></path><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"></path></svg><span class="btn-svg-text">File</span></button>
											<button type="button" class="btn btn-warning btn-svgs btn-svg-white"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M5 19h14V8H5v11zm5.55-6v-3h2.91v3H16l-4 4-4-4h2.55z" opacity=".3"></path><path d="M16 13h-2.55v-3h-2.9v3H8l4 4zm4.54-7.77l-1.39-1.68C18.88 3.21 18.47 3 18 3H6c-.47 0-.88.21-1.16.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6.5c0-.48-.17-.93-.46-1.27zM6.24 5h11.52l.81.97H5.44l.8-.97zM19 19H5V8h14v11z"></path></svg> <span class="btn-svg-text">Download</span></button>
											<button type="button" class="btn btn-success btn-svgs btn-svg-white"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M5 8h14V6H5z" opacity=".3"></path><path d="M7 11h2v2H7zm12-7h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2zm-4 3h2v2h-2zm-4 0h2v2h-2z"></path></svg> <span class="btn-svg-text">Calendar</span></button>
											<button type="button" class="btn btn-danger  btn-svgs btn-svg-white"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><circle cx="18" cy="5" opacity=".3" r="1"></circle><circle cx="6" cy="12" opacity=".3" r="1"></circle><circle cx="18" cy="19.02" opacity=".3" r="1"></circle><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92c0-1.61-1.31-2.92-2.92-2.92zM18 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM6 13c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm12 7.02c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"></path></svg><span class="btn-svg-text"> Share</span></button>
										</div>
									</div>
								</div>
							</div>
						...
						<div  class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											...
											<button type="button" class="btn btn-success btn-md mb-1">Medium button</button>
											<button type="button" class="btn btn-danger btn-lg mb-1">Large button</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button type="button" class="btn bg-primary-transparent btn-lg btn-block">Block level button</button>
											<button type="button" class="btn bg-info-transparent btn-md btn-block">Block level button</button>
											<button type="button" class="btn bg-success-transparent btn-sm btn-block">Block level button</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="text-wra">
											<p>Add <code class="highlighter-rouge">.btn-loading</code> to use a loading state on a button. The width of the button deprights on the length of the text inside Since the loading spinner is implemented using the element.</p>
											<div class="example">
												<div class="btn-list btn-animation">
													<button type="button" class="btn btn-success btn-loaders btn-icon">Button</button>
													<button type="button" class="btn btn-primary btn-loaders btn-icon">Button</button>
													<button type="button" class="btn btn-warning btn-loaders btn-icon">Button</button>
													<button type="button" class="btn btn-info btn-loaders btn-icon">Button</button>
												</div>
											</div>
										</div>
									</div>
