								...
								<div class="row row-sm">
									<div class="col-lg-12">
										<div class="card">
											...
											<div class="card-body">
												<div class="table-responsive">
													<button id="button" class="btn btn-primary mb-4 datadelete-table-btn">Delete selected row</button>
																	...
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab111" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab112" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab113" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab4" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab5" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab6" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab7" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab8" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab9" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab10" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab11" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab12" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab13" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab14" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab15" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab16" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab17" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab18" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab19" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab20" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab21" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab22" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab23" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab24" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab25" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab26" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab27" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
																...
																<div class="panel panel-primary receipts-inline-table border-0">
																	<div class="tab-menu-heading p-0 border-0">
																		<div class="tabs-menu1">
																			<!-- Tabs -->
																			<ul class="nav panel-tabs">
																				<li class=""><a href="#tab28" class="active" data-bs-toggle="tab">Receipts</a></li>
																				<li><a href="#tab29" data-bs-toggle="tab">History</a></li>
																				<li><a href="#tab30" data-bs-toggle="tab">Waste</a></li>
																			</ul>
																		</div>
																	</div>
																	<div class="panel-body tabs-menu-body p-0 border-0">
