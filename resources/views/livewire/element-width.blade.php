								...
								<div class="card">
									...
									<div class="card-body">
										<div class="d-flex">
											...
											<div class="d-flex align-items-center justify-content-center w-150 h-9 bg-light ms-4">
												.w-150
											</div>
											<div class="d-flex align-items-center justify-content-center w-50 h-9 bg-light ms-4">
												.w-50
											</div>
										</div>
