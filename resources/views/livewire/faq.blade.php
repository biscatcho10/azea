...
@section('content')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0 text-primary">FAQ's</h4>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
									...
									<div class="panel-group" id="accordion1" role="tablist" aria-multiselectable="true">
										...
										<div class="panel panel-default mt-2">
											<div class="panel-heading" role="tab" id="heading4">
												<h4 class="panel-title">
													<a class="collapsed" role="button" data-bs-toggle="collapse" data-parent="#accordion1" href="#collapse4" aria-expanded="false" aria-controls="collapseThree3">
										...
										<div class="panel panel-default mt-2">
											<div class="panel-heading" role="tab" id="heading5">
												<h4 class="panel-title">
													<a class="collapsed" role="button" data-bs-toggle="collapse" data-parent="#accordion1" href="#collapse5" aria-expanded="false" aria-controls="collapseThree3">
										...
										<div class="panel panel-default mt-2">
											<div class="panel-heading" role="tab" id="heading6">
												<h4 class="panel-title">
													<a class="collapsed" role="button" data-bs-toggle="collapse" data-parent="#accordion1" href="#collapse6" aria-expanded="false" aria-controls="collapseThree3">
								...
								<div class="card mb-lg-0">
									...
									<div class="card-body">
										<h5>If Your Query Not Clarified Post Your Question, My Customer Support will help You</h5>
										<div class="pt-4">
											...
											<a href="javascript:void(0);" class="btn btn-primary">Send Question</a>
										</div>
									</div>
								</div>
							</div>
