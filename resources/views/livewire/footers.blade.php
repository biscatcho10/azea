...
@section('content')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0 text-primary">Footers</h4>
							</div>
											...
											<div class="container">
												<div class="row align-items-center">
													...
													<div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
														Copyright © 2021<a href="javascript:void(0);">Azea</a>. Designed by <a href="javascript:void(0);">Spruko Pvt.Ltd</a> All rights reserved.
													</div>
												</div>
											</div>
										</div>
											...
											<div class="container">
												<div class="row align-items-center">
													...
													<div class="col-lg-6 col-sm-12 col-md-7 mt-3 mt-lg-0 text-md-right">
														Copyright © 2021<a href="javascript:void(0);">Azea</a>.All rights reserved.
													</div>
												</div>
											</div>
										</div>
												...
												<div class="p-4">
													<div class="row align-items-center">
														<div class="col-lg-6 col-md-6 d-md-block ">
															Copyright © 2021<a href="javascript:void(0);">Azea</a>.
														</div>
														<div class="col-lg-6 col-md-6 text-end privacy">
															<a href="javascript:void(0);" class="btn btn-link" >Privacy</a>
															<a href="javascript:void(0);" class="btn btn-link" >Terms</a>
