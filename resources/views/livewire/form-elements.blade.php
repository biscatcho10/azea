...
@section('content')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0 text-primary">Form Elements</h4>
							</div>
									...
									<div class="card-body">
										<div class="form-group">
											...
											<select name="country" id="select-countries" class="form-control custom-select select2">
												<option value="br" data-data='{"image": "{{asset('assets/images/flags/br.svg')}}"}'>Brazil</option>
												<option value="cz" data-data='{"image": "{{asset('assets/images/flags/cz.svg')}}"}'>Czech Republic</option>
												<option value="de" data-data='{"image": "{{asset('assets/images/flags/de.svg')}}"}'>Germany</option>
												<option value="pl" data-data='{"image": "{{asset('assets/images/flags/pl.svg')}}"}' selected>Poland</option>
											</select>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<div class="input-group-append">
													...
													<button data-bs-toggle="dropdown" type="button" class="btn btn-primary dropdown-toggle"></button>
