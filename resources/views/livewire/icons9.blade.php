...
@section('content')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0 text-primary">Typicons</h4>
							</div>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-12 col-sm-12 mb-4">
												<p class="mb-2">Simply beautiful open source icons. For more info <a class="fs-16 text-primary font-weight-bold" href="https://www.s-ings.com/typicons/" target="_blank">click here</a>.</p>
