...
@section('content')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Edit Invoice</h4>
							</div>
											...
											<div class="col-12">
												...
												<div class="form-group row">
													<div class="col-md-6">
														...
														<textarea class="form-control" rows="4" placeholder="Bill To">Street Address, State, City, Region, Postal Code, ctr@example.com</textarea>
													</div>
													<div class="col-md-6">
														<label class="form-label">Subject</label>
														<textarea class="form-control" placeholder="Subject of Invoice" rows="4">Hi Patrenna Allen,This is the receipt for a payment of $450.00 (USD) for your works</textarea>
													</div>
												</div>
											</div>
										</div>
