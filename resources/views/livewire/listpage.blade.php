						...
						<div class="row">
							<div class="col-sm-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<ul class="list-group">
											<li class="list-group-item"><i class="fa fa-check me-2" aria-hidden="true"></i> Cras justo odio</li>
											<li class="list-group-item"><i class="fa fa-check me-2" aria-hidden="true"></i> Dapibus ac facilisis in</li>
											<li class="list-group-item"><i class="fa fa-check me-2" aria-hidden="true"></i> Morbi leo risus</li>
											<li class="list-group-item"><i class="fa fa-check me-2" aria-hidden="true"></i> Porta ac consectetur ac</li>
											<li class="list-group-item"><i class="fa fa-check me-2" aria-hidden="true"></i> Vestibulum at eros</li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-sm-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<ul class="list-group">
											<li class="list-group-item"><i class="fa fa-cog text-primary me-2" aria-hidden="true"></i> Dapibus ac facilisis in</li>
											<li class="list-group-item"><i class="fa fa-cog text-danger me-2" aria-hidden="true"></i> Dapibus ac facilisis in</li>
											<li class="list-group-item"><i class="fa fa-cog text-success me-2" aria-hidden="true"></i> Cras sit amet nibh libero</li>
											<li class="list-group-item"><i class="fa fa-cog text-warning me-2" aria-hidden="true"></i> Porta ac consectetur ac</li>
											<li class="list-group-item"><i class="fa fa-cog text-info me-2" aria-hidden="true"></i> Vestibulum at eros</li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="list-group">
											<a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-left active">
							...
							<div class="col-sm-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="list-group">
											<a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-left disabled">
												<div class="d-flex w-100 justify-content-between">
													<h5 class="mb-1">List group item heading</h5>
													<small>3 days ago</small>
												</div>
