...
@section('content')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0 text-primary">Loaders</h4>
							</div>
							...
							<div class="col-md-12 col-lg-6 col-xl-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="dimmer active">
											<div class="loader7">
												<span class="circles circle-1"></span>
												<span class="circles circle-2"></span>
												<span class="circles circle-3"></span>
												<span class="circles circle-4"></span>
												<span class="circles circle-5"></span>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="dimmer active">
											<div class="loader8">
												...
												<div class="circle1circle-3"></div>
												<div class="circle1 circle-4"></div>
												<div class="circle1 circle-5"></div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row row-deck">
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">loaders9</h3>
									</div>
									<div class="card-body">
										<div class="dimmer active">
											<div class="spinner">
							...
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">loaders10</h3>
									</div>
									<div class="card-body">
										<div class="dimmer active">
											<div class="spinner1">
