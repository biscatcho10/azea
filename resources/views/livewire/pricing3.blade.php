												...
												<div class="panel price panel-color bg-white">
													...
													<div class="bg-primary-transparent">
														<div class="panel-body text-center mb-3">
															<p class="lead text-primary"><strong class="">$175 </strong>/  year</p>
														</div>
											...
											<div class="col-sm-6 col-lg-3">
												<div class="panel price panel-color bg-white">
													...
													<div class="bg-danger-transparent">
														<div class="panel-body text-center mb-3">
															<p class="lead text-danger"><strong class="">$225</strong>/  year</p>
														</div>
														<ul class="text-center">
											...
											<div class="col-sm-6 col-lg-3">
												<div class="panel price panel-color bg-white">
													...
													<div class="bg-warning-transparent">
														<div class="panel-body text-center mb-3">
															<p class="lead text-warning"><strong class="">$1029</strong>/  year</p>
														</div>
														<ul class="text-center">
											...
											<div class="col-sm-6 col-lg-3">
												<div class="panel price panel-color bg-white">
													...
													<div class="bg-success-transparent">
														<div class="panel-body text-center mb-3">
															<p class="lead text-success"><strong class="">$435 </strong>/  year</p>
														</div>
														<ul class="text-center">
										...
										<div class="row row-sm pricing-style01">
											...
											<div class="col-sm-6 col-lg-3">
												<div class="panel price panel-color bg-white">
													...
													<div class="bg-success-transparent">
														<div class="panel-body text-center mb-3">
															<p class="lead"><strong class=" text-success">$35 </strong>/  month</p>
														</div>
														<ul class="text-center">
															<li class="mb-4"><strong> 4 Free</strong> Domain Name</li>
															<li class="mb-4"> <strong>6 </strong> One-Click Apps</li>
							...
							<div class="text-center">
								<div class="pri-tabs-heading pri-tabs-heading2">
									<ul class="nav nav-price">
										...
										<li><a class="" data-bs-toggle="tab" href="#year1">Year</a></li>
									</ul>
								</div>
								<div class="tab-content">
										...
										<div class="row text-center">
											...
											<div class="col-lg-3">
												<div class="card plan-card shadow-none border">
													<div class="card-block">
														<div class="pt-4 pb-4">
															<h1><i class="fa fa-trophy plan-icon bg-success"></i></h1>
												...
												<div class="card plan-card shadow-none border">
													<div class="card-block">
														...
														<div class="plan-features pb-4 mt-4 text-muted padding-t-b-30">
															...
															<p><strong>Money</strong> BackGuarntee</p>
															<p><strong>24/7</strong> Support</p>
															<a href="javascript:void(0);" class="btn btn-lg btn-info mt-4">Sign Up Now</a>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="card plan-card shadow-none border">
													<div class="card-block">
														...
														<div class="plan-features pb-4 mt-4 text-muted padding-t-b-30">
															...
															<p><strong>Money</strong> BackGuarntee</p>
															<p><strong>24/7</strong> Support</p>
															<a href="javascript:void(0);" class="btn btn-lg btn-danger mt-4">Sign Up Now</a>
														</div>
													</div>
												</div>
											</div>
						...
						<div class="pricing-tabs">
							<div class="text-center">
								<div class="pri-tabs-heading pri-tabs-heading3">
									<ul class="nav nav-price">
										<li><a class="" data-bs-toggle="tab" href="#week">Week</a></li>
										<li><a class="" data-bs-toggle="tab" href="#month2">Month</a></li>
