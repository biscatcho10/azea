										...
										<div class="widget-user-image1 d-xl-flex d-block">
											...
											<div class="mt-1 ms-xl-5">
												...
												<ul class="mb-0 pro-details">
													<li><span class="profile-icon bg-danger-transparent text-danger"><i class="fe fe-globe"></i></span><span class="h6 mt-3">https://demo.com</span></li>
													<li><span class="profile-icon bg-success-transparent text-success"><i class="fe fe-mail"></i></span><span class="h6 mt-3">jessica@gmail.com</span></li>
													<li><span class="profile-icon bg-info-transparent text-info"><i class="fe fe-flag"></i></span><span class="h6 mt-3">English, German</span></li>
													<li><span class="profile-icon bg-warning-transparent text-warning"><i class="fe fe-phone-call"></i></span><span class="h6 mt-3">+345 657 567</span></li>
												</ul>
											</div>
										</div>
									</div>
									...
									<div class="tab-menu-heading p-0">
										<div class="tabs-menu1 px-3">
											<ul class="nav">
												...
												<li><a href="#tab-9" data-bs-toggle="tab" class="fs-14">Timeline</a></li>
											</ul>
										</div>
									</div>
								</div>
										...
										<div class="tab-pane" id="tab-8">
											<div class="card p-5">
												<div class="row">
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															...
															<div class="float-end ms-auto">
																<a href="javascript:void(0);" class="btn btn-primary btn-md">View</a>
															</div>
														</div>
													</div>
													<div class="col-lg-6">
													...
													<div class="col-md-12">
														<a class="btn d-grid btn-light" href="javascript:void(0);"><i class="fe fe-chevron-down"></i> See All</a>
													</div>
												</div>
											</div>
										</div>
