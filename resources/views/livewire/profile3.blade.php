									...
									<div class="card-body">
										<div class="box-widget widget-user text-center">
											...
											<div class="mt-4 ms-sm-5 ms-0">
												...
												<div>
													<span class="badge fs-13 bg-primary-transparent text-primary border-primary  me-2">admin</span>
													<span class="badge fs-13 bg-success-transparent text-success border-success">Director</span>
												</div>
